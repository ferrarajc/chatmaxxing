...
interface AgentStore {
  ...
  addContact: (contact: Omit<ContactSlot, 'messages' | 'isAutopilot' | 'connectionToken' | 'suggestedText' | 'suggestedResources' | 'lastAgentMessageAt' | 'lastCustomerMessageAt'>) => number | null;
