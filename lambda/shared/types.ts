...
export const KNOWLEDGE_BASE: Resource[] = [
  { id: 'kb-001', title: 'Fund Performance FAQ',              url: '/portfolio',                          tags: ['performance', 'returns', 'fund', 'yield', 'benchmark'] },
  ...
  { id: 'kb-009', title: 'Trading Hours & Order Types',       url: '/portfolio',                          tags: ['trading', 'order', 'buy', 'sell', 'hours', 'market', 'limit'] },
  { id: 'kb-010', title: 'Password Reset & Account Access',   url: '/account',                            tags: ['password', 'login', 'access', 'reset', 'locked', 'two-factor'] },
  { id: 'kb-011', title: '401(k) to IRA Rollover Guide',      url: '/resources/rollover',                 tags: ['rollover', '401k', 'ira', 'employer', 'plan', 'pension'] },
  { id: 'kb-012', title: 'Cost Basis Methods Explained',      url: '/portfolio',                          tags: ['cost', 'basis', 'fifo', 'average', 'capital', 'gains', 'tax'] },
  { id: 'kb-013', title: 'Systematic Investment Plans',       url: '/account/auto-invest',                tags: ['systematic', 'automatic', 'recurring', 'investment', 'plan', 'schedule'] },
  { id: 'kb-014', title: 'Wire Transfers & Bank Linking',     url: '/account',                            tags: ['wire', 'bank', 'ach', 'link', 'transfer', 'withdrawal', 'deposit'] },
  { id: 'kb-015', title: 'Account Statements & Reports',      url: '/portfolio',                          tags: ['statement', 'report', 'quarterly', 'annual', 'history', 'download'] },
  { id: 'kb-016', title: 'Opening a New Account',             url: '/open-account',                       tags: ['open', 'new', 'account', 'application', 'start', 'enroll'] },
  { id: 'kb-017', title: 'Dividend Reinvestment (DRIP)',      url: '/account/auto-invest',                tags: ['dividend', 'reinvestment', 'drip', 'automatic', 'compounding'] },
  { id: 'kb-018', title: 'Estate Planning & Inherited Accounts', url: '/resources/estate-planning',       tags: ['estate', 'inherited', 'trust', 'death', 'beneficiary', 'probate'] },
  { id: 'kb-019', title: 'Fund Prospectus Library',           url: '/research',                           tags: ['prospectus', 'fund', 'document', 'disclosure', 'risk', 'objective'] },
  { id: 'kb-020', title: 'Contact Us & Support Hours',        url: '/',                                   tags: ['contact', 'support', 'hours', 'phone', 'email', 'chat', 'help'] },
  { id: 'kb-021', title: 'How to Place a Trade',              url: '/portfolio',                          tags: ['trade', 'buy', 'sell', 'purchase', 'redeem', 'exchange', 'order', 'liquidate'] },
  { id: 'kb-022', title: 'Inheriting an Account',             url: '/resources/estate-planning',          tags: ['inherit', 'inheritance', 'deceased', 'death', 'beneficiary', 'estate', 'transfer', 'condolence'] },
];
