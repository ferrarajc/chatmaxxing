  ...
  try {
    ...
    if (params.clientId) {
      const result = await docClient.send(new QueryCommand({
        ...
        ProjectionExpression: 'transcriptId, clientId, clientName, transcriptType, intentSummary, summary, acwSummary, agentName, startTime, endTime, durationMs, wrapUpCode, messageCount, savedAt, pinned',
      }));
