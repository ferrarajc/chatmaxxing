...
- Name: pages.spec.ts >> Portfolio Page >> shows contribution transactions
- Location: e2e\pages.spec.ts:119:7
...
Locator: getByText(/contribution/i).first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText(/contribution/i).first()
