...
- Name: pages.spec.ts >> Portfolio Page >> shows allocation chart section
- Location: e2e\pages.spec.ts:123:7
...
Locator: getByText(/allocation/i)
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText(/allocation/i)
