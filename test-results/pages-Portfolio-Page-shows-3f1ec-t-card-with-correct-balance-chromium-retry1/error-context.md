...
- Name: pages.spec.ts >> Portfolio Page >> shows Roth IRA account card with correct balance
- Location: e2e\pages.spec.ts:74:7
...
Call log:
  ...
  - waiting for getByText('Roth IRA')
