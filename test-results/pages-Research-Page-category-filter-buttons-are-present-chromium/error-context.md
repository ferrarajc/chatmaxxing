...
- Name: pages.spec.ts >> Research Page >> category filter buttons are present
- Location: e2e\pages.spec.ts:159:7
...
Locator: getByRole('button', { name: /all/i })
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /all/i })
