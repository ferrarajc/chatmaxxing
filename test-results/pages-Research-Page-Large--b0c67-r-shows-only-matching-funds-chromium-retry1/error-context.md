...
- Name: pages.spec.ts >> Research Page >> Large Cap Blend filter shows only matching funds
- Location: e2e\pages.spec.ts:172:7
...
Call log:
  - waiting for getByRole('button', { name: /large cap blend/i })
