...
- Name: pages.spec.ts >> Research Page >> shows all 6 fund cards
- Location: e2e\pages.spec.ts:145:7
...
Locator: getByText('BobsFunds 500 Index')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText('BobsFunds 500 Index')
