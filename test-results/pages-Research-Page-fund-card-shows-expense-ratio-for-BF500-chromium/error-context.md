...
- Name: pages.spec.ts >> Research Page >> fund card shows expense ratio for BF500
- Location: e2e\pages.spec.ts:189:7
...
```ts
  91  |     await expect(page.getByText('Roth IRA').first()).toBeVisible({ timeout: 10000 });
  92  |     await expect(page.getByText(/45[,.]230/).first()).toBeVisible({ timeout: 10000 });
  93  |   });
  94  | 
  95  |   test('shows Traditional IRA account card with correct balance', async ({ page }) => {
