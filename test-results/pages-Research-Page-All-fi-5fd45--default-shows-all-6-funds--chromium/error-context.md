...
- Name: pages.spec.ts >> Research Page >> "All" filter is selected by default (shows all 6 funds)
- Location: e2e\pages.spec.ts:165:7
...
Locator: getByText(/BobsFunds/).first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText(/BobsFunds/).first()
