...
- Name: pages.spec.ts >> Research Page >> Intermediate Bond filter shows Bond Income fund
- Location: e2e\pages.spec.ts:178:7
...
Call log:
  - waiting for getByRole('button', { name: /intermediate bond/i })
