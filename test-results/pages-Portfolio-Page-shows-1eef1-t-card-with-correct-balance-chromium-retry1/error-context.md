...
- Name: pages.spec.ts >> Portfolio Page >> shows Traditional IRA account card with correct balance
- Location: e2e\pages.spec.ts:79:7
...
Locator: getByText('Traditional IRA')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText('Traditional IRA')
