...
- Name: chat-widget.spec.ts >> Chat input >> send button is disabled when input is empty
- Location: e2e\chat-widget.spec.ts:216:7
...
```
Error: locator.getAttribute: Test timeout of 40000ms exceeded.
Call log:
...
- generic [ref=e3]:
  ...
  - generic [ref=e86]:
    ...
    - generic [ref=e93]:
      ...
      - generic [ref=e106]:
        - textbox "Type a message…" [active] [ref=e107]
