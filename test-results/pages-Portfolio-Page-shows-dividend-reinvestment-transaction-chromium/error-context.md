...
- Name: pages.spec.ts >> Portfolio Page >> shows dividend reinvestment transaction
- Location: e2e\pages.spec.ts:115:7
...
Locator: getByText(/dividend reinvestment/i)
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText(/dividend reinvestment/i)
