...
- Name: pages.spec.ts >> Portfolio Page >> has My Portfolio heading
- Location: e2e\pages.spec.ts:70:7
...
Locator: getByRole('heading', { name: /my portfolio/i })
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /my portfolio/i })
