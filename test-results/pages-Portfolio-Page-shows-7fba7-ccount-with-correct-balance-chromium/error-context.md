...
- Name: pages.spec.ts >> Portfolio Page >> shows Taxable Account with correct balance
- Location: e2e\pages.spec.ts:84:7
...
Locator: getByText('Taxable Account')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText('Taxable Account')
