...
- Name: pages.spec.ts >> Portfolio Page >> recent transactions section is present
- Location: e2e\pages.spec.ts:111:7
...
Locator: getByText(/recent transactions/i)
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText(/recent transactions/i)
