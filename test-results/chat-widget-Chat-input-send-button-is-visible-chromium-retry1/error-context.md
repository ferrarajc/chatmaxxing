...
- Name: chat-widget.spec.ts >> Chat input >> send button is visible
- Location: e2e\chat-widget.spec.ts:181:7
...
Locator: locator('button[type="submit"], button').filter({ hasText: /send/i }).first()
Expected: visible
Timeout: 10000ms
...
- generic [ref=e3]:
  ...
  - generic [ref=e86]:
    ...
    - generic [ref=e93]:
      ...
      - generic [ref=e106]:
        - textbox "Type a message…" [ref=e107]
