            ...
            <div style={{ display: 'flex', gap: 20, paddingTop: 14, borderTop: `1px solid ${theme.color.border}` }}>
              <div>
                <div style={{
                  ...
                  color: fund.returns.oneYear > 0 ? theme.color.success : theme.color.danger,
                  fontFamily: theme.font.serif, fontVariantNumeric: 'tabular-nums',
                }}>
              ...
              <div>
                <div style={{ fontSize: 18, fontWeight: 600, color: theme.color.text, fontFamily: theme.font.serif, fontVariantNumeric: 'tabular-nums' }}>{fund.expenseRatio}%</div>
