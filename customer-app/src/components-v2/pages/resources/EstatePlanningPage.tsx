...
export function EstatePlanningPage() {
  return (
    <div style={{ maxWidth: 720, margin: '0 auto', padding: '32px 24px', fontFamily: theme.font.sans }}>
      <h1 style={{ margin: '0 0 6px', fontSize: 28, fontWeight: 800, fontFamily: theme.font.serif }}>Estate Planning & IRAs</h1>
      ...
      <div style={{ ...card, background: theme.color.warningSoft, border: `1px solid ${theme.color.warningBorder}` }}>
        <h2 style={{ margin: '0 0 10px', fontSize: 16, fontWeight: 700, color: theme.color.warning, fontFamily: theme.font.serif }}>Most Important Step: Update Your Beneficiaries</h2>
      ...
      <div style={card}>
        <h2 style={{ margin: '0 0 16px', fontSize: 16, fontWeight: 700, fontFamily: theme.font.serif }}>Beneficiary Rules by Account Type</h2>
        {[
          {
          ...
          <div key={item.type} style={{ marginBottom: 20 }}>
            <h3 style={{ margin: '0 0 8px', fontSize: 14, fontWeight: 700, color: theme.color.primary }}>{item.type}</h3>
            <ul style={{ margin: 0, paddingLeft: 20, lineHeight: 1.8, fontSize: 14, color: theme.color.text }}>
      ...
      <div style={card}>
        <h2 style={{ margin: '0 0 12px', fontSize: 16, fontWeight: 700, fontFamily: theme.font.serif }}>The 10-Year Rule (SECURE Act 2019)</h2>
      ...
      <div style={card}>
        <h2 style={{ margin: '0 0 12px', fontSize: 16, fontWeight: 700, fontFamily: theme.font.serif }}>Using a Trust as Beneficiary</h2>
        <p style={{ margin: '0 0 10px', fontSize: 14, color: theme.color.text, lineHeight: 1.6 }}>
