...
export function SepIraPage() {
  return (
    <div style={{ maxWidth: 720, margin: '0 auto', padding: '32px 24px', fontFamily: theme.font.sans }}>
      <h1 style={{ margin: '0 0 6px', fontSize: 28, fontWeight: 800, fontFamily: theme.font.serif }}>SEP-IRA Guide 2025</h1>
      ...
      <div style={{ ...card, background: theme.color.warningSoft, border: `1px solid ${theme.color.warningBorder}` }}>
        <h2 style={{ margin: '0 0 12px', fontSize: 16, fontWeight: 700, color: theme.color.warning, fontFamily: theme.font.serif }}>2025 SEP-IRA Limit: $70,000</h2>
      ...
      <div style={card}>
        <h2 style={{ margin: '0 0 16px', fontSize: 16, fontWeight: 700, fontFamily: theme.font.serif }}>How to Calculate Your Limit</h2>
        <div style={{ background: theme.color.surfaceMuted, borderRadius: 10, padding: '16px', marginBottom: 16 }}>
          <div style={{ fontSize: 13, fontFamily: theme.font.mono, lineHeight: 2.2, color: theme.color.text }}>
        ...
        <p style={{ margin: 0, fontSize: 14, color: theme.color.textMuted, lineHeight: 1.6 }}>
      ...
      <div style={card}>
        <h2 style={{ margin: '0 0 16px', fontSize: 16, fontWeight: 700, fontFamily: theme.font.serif }}>Key Facts</h2>
        {[
      ...
      <div style={card}>
        <h2 style={{ margin: '0 0 12px', fontSize: 16, fontWeight: 700, fontFamily: theme.font.serif }}>Contribution Limit by Income Level (2025)</h2>
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 14 }}>
          ...
          <tbody>
            {[
              ...
              <tr key={r.profit} style={{ borderBottom: `1px solid ${theme.color.border}` }}>
                <td style={{ padding: '10px 8px', fontWeight: 500, textAlign: 'right' }}>{r.profit}</td>
                <td style={{ padding: '10px 8px', textAlign: 'right' }}>{r.limit}</td>
                <td style={{ padding: '10px 8px', color: theme.color.textMuted, textAlign: 'right' }}>{r.pct}</td>
              </tr>
            ))}
          </tbody>
        </table>
