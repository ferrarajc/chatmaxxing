...
export function SelfEmployedRetirementPage() {
  return (
    <div style={{ maxWidth: 720, margin: '0 auto', padding: '32px 24px', fontFamily: theme.font.sans }}>
      <h1 style={{ margin: '0 0 6px', fontSize: 28, fontWeight: 800, fontFamily: theme.font.serif }}>Self-Employed Retirement Options</h1>
      ...
      <div style={card}>
        <h2 style={{ margin: '0 0 16px', fontSize: 16, fontWeight: 700, fontFamily: theme.font.serif }}>Plan Comparison (2025)</h2>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13 }}>
            ...
            <tbody>
              {[
                ...
                <tr key={r.label} style={{ borderBottom: `1px solid ${theme.color.border}` }}>
                  <td style={{ padding: '10px 8px', fontWeight: 600, color: theme.color.text }}>{r.label}</td>
      ...
      <div style={card}>
        <h2 style={{ margin: '0 0 16px', fontSize: 16, fontWeight: 700, fontFamily: theme.font.serif }}>Most Popular for Self-Employed: SEP-IRA</h2>
        ...
        <ul style={{ margin: '0 0 14px', paddingLeft: 20, fontSize: 14, color: theme.color.text, lineHeight: 1.8 }}>
      ...
      <div style={card}>
        <h2 style={{ margin: '0 0 12px', fontSize: 16, fontWeight: 700, fontFamily: theme.font.serif }}>Can I Have a SEP-IRA AND a Day Job 401(k)?</h2>
        <p style={{ margin: '0 0 10px', fontSize: 14, color: theme.color.text, lineHeight: 1.6 }}>
